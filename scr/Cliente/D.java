  ...
  public void run()
  {
    ...
    try
    {
      ...
      if (!linea.equals("HOLA")) {
        ac.println("ERROR");
        sc.close();
        throw new Exception(dlg + "ERROR" + "recibio-" + linea + "-terminando.");
      }
      ac.println("OK");
      ...
      if ((!algoritmos[1].equals("DES")) && (!algoritmos[1].equals("AES")) && 
        ...
        ac.println("ERROR");
        sc.close();
        throw new Exception(dlg + "ERROR" + "Alg.Simetrico" + "recibio-" + algoritmos + "-terminando.");
      }
      if (!algoritmos[2].equals("RSA")) {
        ac.println("ERROR");
        sc.close();
        throw new Exception(dlg + "ERROR" + "Alg.Asimetrico." + "recibio-" + algoritmos + "-terminando.");
      }
      if (!validoAlgHMAC(algoritmos[3])) {
        ac.println("ERROR");
        sc.close();
        throw new Exception(dlg + "ERROR" + "AlgHash." + "recibio-" + algoritmos + "-terminando.");
      }
      System.out.println(dlg + "recibio-" + linea + "-continuando.");
      ac.println("OK");
      ...
      byte[] certificadoClienteBytes = new byte['Ȉ'];
      ...
      if (!linea.equals("OK")) {
        sc.close();
        throw new Exception(dlg + "ERROR" + "en confirmacion de llave simetrica." + "recibio-" + "-terminando.");
      }
